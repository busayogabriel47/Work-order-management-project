...
export default function LoginPage() {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <Text style={{  color: '#006CE3', fontSize: 30, fontWeight: 'bold', marginVertical: 5 }}>
        welcome
       </Text>
       <Text style={{marginVertical: 10}}>
        pls login in to your account
       </Text>
      ...
      <TouchableOpacity style={styles.signInButton} onPress={handleSignIn}>
        ...
        <Text style={styles.forgetPassword}>
          Forget Password? <Text style={{  color: '#006CE3' }}>Contact Your Manager</Text>
        </Text>
      </View>
    </View>
  )
