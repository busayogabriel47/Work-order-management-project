...
import AnalyticsToday from './AnalyticsToday.js'
import AnalysticMontly from './AnalysticMontly.js'
      ...
      <Icon style={styles.arrowIcon} name="arrow-right" size={10} color="#fff"  />
        <Text style={styles.blueBgText}>Analytics</Text>
         ...
         <View style={styles.daysBox}>
                <TouchableOpacity style={styles.daysOption} onPress={() => navigation.navigate('AnalyticsToday')}>
                    <Text>Today</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.daysOption} onPress={() => navigation.navigate('AnalyticsWeekly')}>
                    <Text>Weekly</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.daysOption} onPress={() => navigation.navigate('AnalysticMontly')}>
                    <Text>Monthly</Text>
                </TouchableOpacity>
            </View>
